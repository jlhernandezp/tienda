...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-05-2017 a las 23:54:21
...
('ARCLPMP32GBN', 'HH', 'Archos Clipper MP3 2GB negro', 'Caracterï¿½sticas:Almacenamiento Interno Disponible en 2 GB*Compatibilidad Windows o Mac y Linux (con soporte para almacenamiento masivo)Interfaz para ordenador USB 2.0 de alta velocidadBatterï¿½a2 11 horas mï¿½sicaReproducciï¿½n Mï¿½sica3 MP3Medidas Dimensiones: 52mm x 27mm x 12mm, Peso: 14 Gr', '26.70', 'MP3'),
...
('IXUS115HSAZ', '', 'Canon Ixus 115HS azul', 'Caracterï¿½sticas:\r\nHS System (12,1 MP) \r\nZoom 4x, 28 mm. IS ï¿½ptico \r\nCuerpo metï¿½lico estilizado \r\nPantalla LCD PureColor II G de 7,6 cm (3,0") \r\nFull HD. IS Dinï¿½mico. HDMI \r\nModo Smart Auto (32 escenas) ', '196.70', 'CAMARA'),
...
('OPTIOLS1100', '', 'Pentax Optio LS1100', 'La LS1100 con funda de transporte y tarjeta de memoria de 2GB incluidas \r\nes la compacta digital que te llevarï¿½s a todas partes. \r\nEsta cï¿½mara diseï¿½ada por Pentax incorpora un sensor CCD de 14,1 megapï¿½xeles y un objetivo gran angular de 28 mm.\r\n', '104.80', 'CAMARA'),
